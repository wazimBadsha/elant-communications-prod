...
const getBuddyChatHistory = async (payload, isSenderOnline, isReceiverOnline, isBlocked, blockedInfoSender, blockedInfoReceiver, isYouBlocked, isReceiverBlocked) => {
  try {
    ...
    if (msgHistoryInfo && msgHistoryInfo.length > 0) {
      ...
      messageHistory = transformChatMsgs(msgHistoryInfo, isSenderOnline, isReceiverOnline,isBlocked, blockedInfoSender, blockedInfoReceiver, isYouBlocked, isReceiverBlocked);
    }
